...
### Download the Blockchain from the FullcoinNode Project

The Fullcoin node project provides multiple and regulaly updated direct-link downloads. Copies of bootstrap.dat can be downloaded directly from servers provided by FullcoinNode, or be downloaded from a randomly selected server. All copies of boootstrap are updated at the maximum of every six months.

**Copies of Bootstrap from a specific server**

* [http://mango.fullcoinnode.org/bootstrap.dat](http://mango.fullcoinnode.org/bootstrap.dat)
* [http://apple.fullcoinnode.org/bootstrap.dat](http://apple.fullcoinnode.org/bootstrap.dat)

**Randomly selected dopy of Bootstrap**

This could be useful for use in scripts.

* [http://bootstrap.fullcoinnode.org/bootstrap.dat](http://bootstrap.fullcoinnode.org/bootstrap.dat)
	
**Example usage in a (bash) Terminal**

	wget http://bootstrap.fullcoinnode.org/bootstrap.dat       //downloads bootstrap into current directory
