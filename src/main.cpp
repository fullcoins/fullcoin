...
#if defined(NDEBUG)
# error "Fullcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Fullcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("fullcoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Fullcoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Fullcoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
